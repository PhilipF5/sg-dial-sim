...
export const closeIris = createAction("[Dialing Computer] Close Iris");
...
export const irisClosed = createAction("[Dialing Computer] Iris Closed");
export const irisOpened = createAction("[Dialing Computer] Iris Opened");
